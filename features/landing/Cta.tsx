                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                    <div className="max-w-xl text-center lg:text-left">
                        <h2 className="text-3xl md:text-5xl font-black text-white mb-6 leading-tight">
                            Punya Barang Bekas? <br />
                            <span className="text-green-400">Ubah Jadi Nilai Baru!</span>
                        </h2>
                        <p className="text-gray-400 text-lg mb-0 leading-relaxed">
                            Bergabunglah dengan ribuan pengguna lainnya dan mulai bangun ekosistem berbagi yang lebih baik.
                        </p>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link href={'/register'} className="px-10 py-5 bg-green-500 text-gray-900 rounded-2xl font-black text-lg hover:bg-green-400 transition-all shadow-lg shadow-green-500/20 active:scale-95">
                            Daftar Sekarang
                        </Link>
                    </div>
                </div>

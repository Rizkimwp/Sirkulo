      ...
      >
        <div className="bg-white/90 backdrop-blur-2xl p-10 rounded-[3rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.08)] border border-white">
          ...
          <div className="text-center mb-8">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16"/><path d="M16 16h5v5"/></svg>
            </div>
            <h2 className="text-3xl font-black text-gray-900 tracking-tight">Buat Akun</h2>
            <p className="text-gray-500 mt-2 font-medium">Bergabung dengan revolusi Sirkulo</p>
          </div>
          ...
          <div className="relative flex items-center justify-center my-8">
            ...
            <span className="absolute bg-[#fdfdfd] px-4 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Atau Manual</span>
          </div>

          {/* Form Section */}
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[11px] font-black text-gray-400 uppercase tracking-wider mb-2 ml-1">Email</label>
              <input
                type="email"
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                <label className="block text-[11px] font-black text-gray-400 uppercase tracking-wider mb-2 ml-1">Password</label>
                <input
                  type="password"
                  placeholder="••••••••"
                  value={password}
              ...
              <div>
                <label className="block text-[11px] font-black text-gray-400 uppercase tracking-wider mb-2 ml-1">Konfirmasi Password</label>
                <input
                  type="password"
                  placeholder="••••••••"
            ...
            <div className="py-2">
              <label className="flex items-center gap-3 cursor-pointer group">
                <input type="checkbox" required className="w-5 h-5 rounded-md border-gray-300 text-emerald-600 focus:ring-emerald-500 transition-all cursor-pointer" />
                <span className="text-xs text-gray-500 font-medium group-hover:text-gray-700">Saya setuju dengan Syarat & Ketentuan</span>
              </label>
            </div>
          ...
          <p className="mt-8 text-sm text-gray-500 text-center font-medium">
            ...
            <a href="/login" className="text-emerald-600 font-black hover:underline underline-offset-4 transition-all">
              Login Masuk
            </a>
          </p>
        </div>

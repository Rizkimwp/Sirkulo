      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 text-green-700 text-sm font-bold mb-6">
            <Sparkles size={16} />
            <span>Re-use, Re-love, Re-cycle</span>
          </div>
          ...
          <p className="text-lg text-gray-500 mb-10 max-w-md leading-relaxed">
            A modern circular platform that transforms unused goods in your
            storage into valuable points — so you can exchange them for what
          ...
          <div className="mt-12 flex items-center gap-4 border-t border-gray-100 pt-8">
            ...
            <p className="text-sm text-gray-500 font-medium">
              <span className="text-gray-900 font-bold">1,200+</span> people are
              exchanging goods today
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            <Image src={bottle} alt="Plastic Bottle" className="w-20 h-20" />
          </motion.div>
          ...
          >
            <Image src={cardboard} alt="Cardboard Waste" className="w-24 h-24" />
          </motion.div>
          ...
          >
            <Image src={can} alt="Aluminum Can" className="w-16 h-16" />
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-lg font-black text-gray-900">+450 Points</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-2">
                <p className="text-[10px] text-emerald-300 font-bold uppercase tracking-[0.15em]">
                  Status
                </p>
              ...
              <p className="text-[9px] text-emerald-400/80 font-medium italic">
                Ready for pickup
              </p>
            </div>
          </motion.div>

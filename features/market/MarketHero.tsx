...
const MarketHero = ({search, setSearch}:{search:string; setSearch:React.Dispatch<React.SetStateAction<string>>}) => {

    return (
        <div className="max-w-7xl mx-auto mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="max-w-2xl text-left">
                <span className="text-green-600 font-bold tracking-[0.2em] uppercase text-sm mb-2 block">Eco-Friendly Exchange</span>
                <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-4 tracking-tight">
                    Market <span className="text-green-600">Sirkulo</span>
                </h2>
                <p className="text-lg text-gray-500">
                    Tukarkan poin yang Anda kumpulkan dengan barang berkualitas yang siap mendapatkan pemilik baru.
                </p>
            </div>

...
import { motion } from 'framer-motion'; // Tambahkan framer-motion untuk kesan premium
...
const LoginAuth: React.FC<LoginAuthProps> = ({ onLogin, onGoogleLogin }) => {
      ...
      >
        <div className="bg-white/80 backdrop-blur-xl p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-white">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2 font-medium">Masuk untuk mulai berdampak</p>
          </div>
          ...
          <div className="relative flex items-center justify-center my-8">
            ...
            <span className="absolute bg-[#fdfdfd] px-4 text-xs font-bold text-gray-400 uppercase tracking-widest">Atau Email</span>
          </div>

          {/* Form Login */}
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Alamat Email</label>
              <input
                type="email"
          ...
          <p className="mt-8 text-sm text-gray-500 text-center font-medium">
            Baru di Sirkulo?{' '}
            <a href="/register" className="text-emerald-600 font-bold hover:underline underline-offset-4">
              Buat Akun Gratis
            </a>
          </p>
        </div>

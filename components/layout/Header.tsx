...
export default function Header() {
  ...
  const navLinks = [
    ...
    { name: 'Cara Kerja', href: '/faq', icon: LayoutGrid },
    { name: 'Donasi', href: '/donasi', icon: Heart, badge: 'Baru' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 flex justify-between items-center">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          ...
          <div className="flex items-center gap-3">
            <Link key={'login'} href="/login" className="px-5 py-2.5 text-sm font-bold text-gray-700 hover:text-green-600 transition-colors">
              Masuk
            </Link>
            <Link 
            key={'register'}
